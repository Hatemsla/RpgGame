...
namespace World.Player
{
    public sealed class PlayerInputSystem : IEcsRunSystem, IEcsInitSystem
    {
        ...
        private readonly EcsCustomInject<InputService> _is = default;
        ...
        {
            var inputComp = new PlayerInputComp();
            ...
            // string json = JsonUtility.ToJson(inputComp, true);
            // Debug.Log(json);

            _is.Value.GetNetworkInput(inputComp);
        }
    }
}